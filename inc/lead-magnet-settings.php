...
const BHP_LEAD_MAGNET_PDF_KEYS = [
    'mariana_teacher', 'mariana_parent', 'adventure_kit_parent',
    'teacher_toolkit', 'gift_guide', 'bookstore_wholesale_guide', 'community_reading_kit',
];
...
function bhp_render_lead_magnet_settings_page() {
    ...
    $fields = [
        ...
        'teacher_toolkit' => [
            'label' => __('Adventure Learning Toolkit (Teacher PDF)', 'brave-hearts'),
            'help'  => __('Leave blank until the toolkit is ready. The Teachers/Librarians/Homeschool landing page stays in a "coming soon" state until this is set.', 'brave-hearts'),
        ],
        'gift_guide' => [
            'label' => __('Meaningful Gift Guide (PDF)', 'brave-hearts'),
            'help'  => __('Leave blank until the guide is ready. The Gift Buyers landing page stays in a "coming soon" state until this is set.', 'brave-hearts'),
        ],
        'bookstore_wholesale_guide' => [
            'label' => __('Wholesale Guide (Bookstores/Retailers PDF)', 'brave-hearts'),
            'help'  => __('Leave blank until the guide is ready. The Bookstores/Retailers landing page stays in a "coming soon" state until this is set.', 'brave-hearts'),
        ],
        'community_reading_kit' => [
            'label' => __('Community Reading Kit (Organizations PDF)', 'brave-hearts'),
            'help'  => __('Leave blank until the kit is ready. The Organizations landing page stays in a "coming soon" state until this is set.', 'brave-hearts'),
        ],
    ];
    ?>
    <div class="wrap">
