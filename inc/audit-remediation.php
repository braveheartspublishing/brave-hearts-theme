...
function bhp_product_collection_upsell() {
	...
	if ( ! $printed_css ) {
		...
		echo '<style id="bhp-cc-upsell-css">'
			...
			. '.bhp-cc-upsell__strike{color:#7a7a70;text-decoration:line-through;font-size:.95rem;}'
			. '.bhp-cc-upsell__price{font-size:1.5rem;font-weight:700;color:var(--bhp-cc-green);}'
			. '.bhp-cc-upsell__save{font-size:.85rem;font-weight:700;color:#8a5a00;background:rgba(217,164,95,.28);padding:.15rem .5rem;border-radius:6px;}'
