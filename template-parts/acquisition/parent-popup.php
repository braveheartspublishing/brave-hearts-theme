...
>
  ...
  >
    ...
    <p id="parent-popup-desc" class="mariana-popup__text">
      <?php esc_html_e('Try a free 20-minute adventure designed for curious kids ages 6–9—with a sample chapter, explorer activity, and simple ways to make reading feel fun again.', 'brave-hearts'); ?>
    </p>
